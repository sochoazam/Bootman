...
$botman->hears('.*financiamiento.*', function (BotMan $bot) {
...
//Ubicacion
$botman->hears('.*ubicaci(ó|o)n.*|.*Ubicaci(ó|o)n.*|.*localizaci(ó|o)n.*|.*localizado.*|(E|e)n donde estan.*|.*ubicado.*|.*ubican.*|.*(E|e)n donde se encuentran.*', function (BotMan $bot) {
