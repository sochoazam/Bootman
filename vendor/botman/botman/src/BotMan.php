...
class BotMan
{
    ...
    public function sendMail($name1, $tel1, $email1){
         ...
         <body> 
         <h1>Un cliente ha solicitado ser contactado contacten.</h1> 
         <p> 
         <b>Los datos de contacto son: </b>. 
         <br> <br>
         <b>Nombre: </b>' .$name1
         .'<br><br> 
         <b>Telefono: </b>' .$tel1 
         ...
         $headers .= "Cc: jakiisanchez25@gmail.com\r\n"; 
